...
export default defineConfig({
  ...
  lang: 'zh-CN',
  base: '/vitepress-site/',  // GitHub Pages 路径
  
  // 站点地图
  sitemap: {
    hostname: 'https://sylvia-x5796.github.io/vitepress-site'
  },
  ...
  head: [
    ...
    ['link', { rel: 'icon', type: 'image/png', sizes: '32x32', href: '/vitepress-site/favicon_io/favicon-32x32.png' }],
    ['link', { rel: 'icon', type: 'image/png', sizes: '16x16', href: '/vitepress-site/favicon_io/favicon-16x16.png' }],
    ['link', { rel: 'apple-touch-icon', sizes: '180x180', href: '/vitepress-site/favicon_io/apple-touch-icon.png' }],
    ['link', { rel: 'manifest', href: '/vitepress-site/favicon_io/site.webmanifest' }],
    
    // RSS 订阅
    ['link', { rel: 'alternate', type: 'application/rss+xml', title: 'RSS Feed', href: '/vitepress-site/feed.rss' }],
    ['link', { rel: 'alternate', type: 'application/atom+xml', title: 'Atom Feed', href: '/vitepress-site/feed.atom' }],
    ['link', { rel: 'alternate', type: 'application/json', title: 'JSON Feed', href: '/vitepress-site/feed.json' }],
    ...
    ['meta', { property: 'og:url', content: 'https://sylvia-x5796.github.io/vitepress-site/' }],
    ['meta', { property: 'og:image', content: 'https://sylvia-x5796.github.io/vitepress-site/logo.png' }],
    ...
    ['meta', { name: 'twitter:image', content: 'https://sylvia-x5796.github.io/vitepress-site/logo.png' }],
